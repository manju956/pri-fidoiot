...
public final class FdoSys {
  ...
  public static final String SVC_URL = NAME + ":svc_url";
  ...
  public static final int SVC_CALL_HTTP_METHOD_GET = 1;
  public static final int SVC_CALL_HTTP_METHOD_POST = 2;
  public static final int SVC_CALL_HTTP_METHOD_PUT = 3;
  public static final int SVC_CALL_HTTP_METHOD_DELETE = 4;
